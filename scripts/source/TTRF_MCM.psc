...
event OnOptionHighlight(int option)
    ...
    elseif(option == oid_SettingsExportData)
        SetInfoText("Exports json data to file in Documents\\My Games\\Skyrim Special Edition\\JCUser\\RelationsFinder\\main.json")
    elseif(option == oid_SettingsClearData)
        SetInfoText("Imports data from file in Documents\\My Games\\Skyrim Special Edition\\JCUser\\RelationsFinder\\main.json")
    endif
endevent